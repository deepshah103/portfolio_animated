...
function PhoneDock() {
  return (
    <group position={[3, 0, -3]}>
      <mesh position={[0, 0.45, 0]} castShadow receiveShadow><boxGeometry args={[0.6, 0.04, 0.5]} /><meshStandardMaterial color="#ffffff" roughness={0.2} metalness={0.1} /></mesh>
      <mesh position={[0, 0.22, 0]} castShadow><cylinderGeometry args={[0.04, 0.04, 0.44, 8]} /><meshStandardMaterial color="#cccccc" metalness={0.9} roughness={0.1} /></mesh>
      <mesh position={[0, 0.52, 0]} castShadow rotation={[-0.3, 0, 0]}><boxGeometry args={[0.12, 0.22, 0.012]} /><meshStandardMaterial color="#1a1a1a" roughness={0.3} /></mesh>
      <mesh position={[0, 0.52, 0.008]} rotation={[-0.3, 0, 0]}><boxGeometry args={[0.1, 0.19, 0.005]} /><meshStandardMaterial color="#ccf4ff" emissive="#0088aa" emissiveIntensity={0.3} /></mesh>
      <mesh position={[0, 0.47, 0]} rotation={[-Math.PI / 2, 0, 0]}><circleGeometry args={[0.15, 16]} /><meshStandardMaterial color="#e0ffff" emissive="#00ccdd" emissiveIntensity={0.5} transparent opacity={0.6} /></mesh>
    </group>
  );
}
...
function Bookshelf() {
  return (
    <group position={[4, 0, -4.5]}>
      ...
      {[
        [-0.4, 0.55, '#22aacc'], [-0.2, 0.55, '#3366cc'], [0, 0.55, '#44bb88'], [0.2, 0.55, '#cc7733'], [0.4, 0.55, '#7744cc'], [-0.3, 1.05, '#cc5544'], [0, 1.05, '#3399cc'], [0.3, 1.05, '#339966'],
      ].map(([x, y, color], i) => <mesh key={i} position={[x as number, y as number, -1.35]} castShadow><boxGeometry args={[0.06, 0.2, 0.15]} /><meshStandardMaterial color={color as string} roughness={0.7} /></mesh>)}
    </group>
  );
}
...
function TradingDesk() {
  ...
  return (
    <group position={[-5, 0, 0]}>
      <mesh position={[0, 0.7, 0]} castShadow receiveShadow><boxGeometry args={[2, 0.04, 0.7]} /><meshStandardMaterial color="#ffffff" roughness={0.2} metalness={0.1} /></mesh>
      {[[-0.9, 0, -0.3], [0.9, 0, -0.3], [-0.9, 0, 0.3], [0.9, 0, 0.3]].map((pos, i) => <mesh key={i} position={[pos[0], 0.35, pos[2]]} castShadow><boxGeometry args={[0.03, 0.7, 0.03]} /><meshStandardMaterial color="#ccc" metalness={0.9} roughness={0.1} /></mesh>)}
      {screens.map((s, i) => <group key={i}><mesh position={[s.x, s.y, -0.3]} castShadow><boxGeometry args={[0.7, 0.42, 0.02]} /><meshStandardMaterial color="#111111" roughness={0.3} /></mesh><mesh position={[s.x, s.y, -0.28]}><boxGeometry args={[0.62, 0.35, 0.01]} /><meshStandardMaterial color="#0a0a0a" emissive={s.emissive} emissiveIntensity={0.4} /></mesh><mesh position={[s.x + 0.28, s.y + 0.18, -0.29]}><sphereGeometry args={[0.015, 8, 8]} /><meshStandardMaterial color={s.emissive} emissive={s.emissive} emissiveIntensity={3} /></mesh></group>)}
      <mesh position={[0, 1.25, -0.33]} castShadow><boxGeometry args={[0.04, 1.1, 0.04]} /><meshStandardMaterial color="#aaa" metalness={0.9} roughness={0.1} /></mesh>
      <mesh position={[0, 0.72, -0.33]} castShadow><boxGeometry args={[0.12, 0.04, 0.08]} /><meshStandardMaterial color="#999" metalness={0.9} roughness={0.1} /></mesh>
      <mesh position={[-0.1, 0.73, 0.1]} castShadow><boxGeometry args={[0.45, 0.012, 0.16]} /><meshStandardMaterial color="#1a1a1a" roughness={0.5} /></mesh>
      <mesh position={[0.4, 0.73, 0.1]} castShadow><boxGeometry args={[0.05, 0.012, 0.08]} /><meshStandardMaterial color="#1a1a1a" roughness={0.4} /></mesh>
      <mesh position={[0, 0.68, -0.33]}><boxGeometry args={[1.8, 0.02, 0.02]} /><meshStandardMaterial color="#00ff66" emissive="#00cc44" emissiveIntensity={2} /></mesh>
    </group>
  );
}
...
function WallDecor() {
  return (
    <group>
      {[[-4.5, 0, -5.5], [3, 0, -5.5], [5.5, 0, -5.5]].map(([x, , z], i) => <group key={i} position={[x, 0, z]}><mesh position={[0, 0.6, 0]} castShadow><cylinderGeometry args={[0.03, 0.03, 1.2, 8]} /><meshStandardMaterial color="#ccc" metalness={0.9} roughness={0.1} /></mesh><mesh position={[0, 1.3, 0]}><boxGeometry args={[0.6, 0.5, 0.02]} /><meshStandardMaterial color="#f0faff" emissive={['#00ccff', '#00ffaa', '#aa88ff'][i]} emissiveIntensity={0.4} roughness={0.2} /></mesh></group>)}
    </group>
  );
}
...
function SideTable() {
  return (
    <group position={[-4.5, 0, 2]}>
      <mesh position={[0, 0.5, 0]} castShadow><cylinderGeometry args={[0.35, 0.35, 0.03, 16]} /><meshStandardMaterial color="#eeffff" roughness={0.1} transparent opacity={0.7} /></mesh>
      <mesh position={[0, 0.25, 0]} castShadow><cylinderGeometry args={[0.04, 0.04, 0.5, 8]} /><meshStandardMaterial color="#cccccc" metalness={0.9} roughness={0.1} /></mesh>
      <mesh position={[0, 0.01, 0]}><cylinderGeometry args={[0.2, 0.2, 0.02, 12]} /><meshStandardMaterial color="#ddd" metalness={0.8} roughness={0.2} /></mesh>
      <mesh position={[0, 0.53, 0]} rotation={[-Math.PI / 2, 0, 0.2]} castShadow><boxGeometry args={[0.2, 0.3, 0.01]} /><meshStandardMaterial color="#1a1a1a" roughness={0.3} /></mesh>
    </group>
  );
}
  ...
  return (
    <group>
      {[
        ...
        [5.5, 0.01, -1], [5.5, 0.01, 3],
      ].map(([x, y, z], i) => <mesh key={i} position={[x, y, z]} rotation={[-Math.PI / 2, 0, 0]}><circleGeometry args={[0.12, 12]} /><meshStandardMaterial color="#ccffff" emissive="#00bbdd" emissiveIntensity={1.5} /></mesh>)}
    </group>
  );
}
...
function WaterCooler() {
  return (
    <group position={[-2, 0, 2.5]}>
      <mesh position={[0, 0.6, 0]} castShadow><cylinderGeometry args={[0.15, 0.15, 1.0, 12]} /><meshStandardMaterial color="#e8f4f8" roughness={0.3} metalness={0.1} /></mesh>
      <mesh position={[0, 1.15, 0]} castShadow><cylinderGeometry args={[0.12, 0.15, 0.15, 12]} /><meshStandardMaterial color="#ccf4ff" roughness={0.1} transparent opacity={0.6} /></mesh>
      <mesh position={[0, 0.08, 0]}><cylinderGeometry args={[0.18, 0.18, 0.15, 12]} /><meshStandardMaterial color="#ddeef4" roughness={0.3} /></mesh>
      <mesh position={[0, 0.1, 0]} rotation={[-Math.PI / 2, 0, 0]}><ringGeometry args={[0.16, 0.19, 16]} /><meshStandardMaterial color="#00ddff" emissive="#00bbdd" emissiveIntensity={1.5} /></mesh>
    </group>
  );
}
